...
%>
		...
		<td><a href="list_skill.jsp?oskillname=<%=oskillname %>"><%=oskillname %></a></td>
		<td><a href="list_warriorstatus.jsp?oid=<%=oid %>">스텟상세정보</a></td>
		<td><a href="detail_search.jsp?oid=<%=oid %>">상세</a></td>
	</tr>
